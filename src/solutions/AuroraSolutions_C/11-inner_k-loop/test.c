...
// IMPORANT A and L do not change for all calls to do_comp 
  do_comp_boolmask(A, B, C, L1, "L1-BOOLM");
  do_comp_static_idxlist(A, B, C, L1, "L1-STIDX");
  do_comp_dynamic_idxlist(A, B, C, L1, "L1-DYIDX");

  do_comp_boolmask(A, B, C, L2, "L2-BOOLM");
  do_comp_static_idxlist(A, B, C, L2, "L2-STIDX");
  do_comp_dynamic_idxlist(A, B, C, L2, "L2-DYIDX");
